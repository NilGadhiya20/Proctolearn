...
import { PageTransitionLoader } from './components';
...
const AppRoutes = () => {
  ...
  useEffect(() => {
    // Show loader briefly when location changes
    setIsLoading(true);
  ...
  return (
    <Box sx={{ width: '100%', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <PageTransitionLoader isVisible={isLoading} />
      <Routes>
        {/* Public Routes */}
        ...
        />
        <Route
          path="/quiz/:quizId/exam/result/:sessionId"
          element={
            <ProtectedRoute requiredRoles={['student']}>
              <ExamResultPage />
            </ProtectedRoute>
